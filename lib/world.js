...
class World{
    constructor(canvas){
        ...
        this.myInfo         = new MyInfo(this, this.scene3D, this.type, this.camera3D, this.fPersonCamera);
        // ユーザー操作
        this.input          = new InputManager(this, this.myInfo, this.camera3D, this.fPersonCamera, this.canvas);
        // 要素
